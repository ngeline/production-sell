...
<div class="row">
    <div class="col-12">
        <div class="card mb-4">
                            ...
                            <?php foreach ($users as $user) : ?>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a role="button" class="btn btn-warning" data-bs-target="#updatePassword" data-bs-toggle="modal"><i class="fas fa-edit"></i> Edit Password</a>
                                    </td>
                                </tr>
                            <?php endforeach ?>
                        </tbody>
            ...
            <div class="mx-3">
                <?= $pager->links('user', 'customPagination') ?>
            </div>
        </div>
    </div>
</div>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="formInput" role="form text-left" action="<?= base_url('users/update/' . $user->id); ?>" method="post">
                        <?= csrf_field(); ?>
                        <input type="hidden" name="_method" value="PUT">
                        <label>Email</label>
                        <div class="input-group mb-3">
                            <input type="email" name="email" id="email" class="form-control <?= (validation_show_error('email') != '') ? 'is-invalid' : ''; ?>" placeholder="Email" required value="<?= old('email', $user->email); ?>">
