<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3" id="sidenav-main">
    <div class="sidenav-header">
        ...
        <a class="navbar-brand m-0">
            ...
            <span class="ms-1 font-weight-bold text-capitalize">Dashboard <?php $user = new \App\Models\UserModel();
                                                                            echo $user->userRole()->find(user()->id)->nameRole; ?></span>
        </a>
    </div>
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
        <ul class="navbar-nav">
            ...
            <?php if (in_groups('admin')) : ?>
                <!-- <li class="nav-item">
                    <a class="nav-link <?= uri_string() == 'supplier' ? 'active' : '' ?>" href="<?= base_url('supplier'); ?>">
                        <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                ...
                <li class="nav-item">
                    <a class="nav-link <?= uri_string() == 'penjualan' ? 'active' : '' ?>" href="<?= base_url('penjualan'); ?>">
                        <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                ...
                <li class="nav-item mt-3">
                    <h6 class="ps-4 ms-2 text-uppercase text-xs font-weight-bolder opacity-6">Data Laporan</h6>
                </li>
                <li class="nav-item">
                    <a class="nav-link <?= uri_string() == 'laporanproduksi' ? 'active' : '' ?>" href="<?= base_url('laporanproduksi'); ?>">
                        <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                ...
                <li class="nav-item">
                    <a class="nav-link <?= uri_string() == 'laporanetalase' ? 'active' : '' ?>" href="<?= base_url('laporanetalase'); ?>">
                        ...
                        <span class="nav-link-text ms-1">Laporan Etalase</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link <?= uri_string() == 'laporanopname' ? 'active' : '' ?>" href="<?= base_url('laporanopname'); ?>">
                        <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                            <svg width="12px" height="12px" viewBox="0 0 40 44" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                                <title>document</title>
                                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                        ...
                        <span class="nav-link-text ms-1">Laporan Opname</span>
                    </a>
                </li>
            <?php endif; ?>
            <!-- end | role: admin -->
            ...
            <?php if (in_groups('owner')) : ?>
                ...
                <li class="nav-item mt-3">
                    <h6 class="ps-4 ms-2 text-uppercase text-xs font-weight-bolder opacity-6">Data Users</h6>
                </li>
                <li class="nav-item">
                    <a class="nav-link <?= uri_string() == 'users' ? 'active' : '' ?>" href="<?= base_url('users'); ?>">
                        <div class="icon icon-shape icon-sm shadow bo/rder-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            ...
            <?php if (in_groups('pegawai')) : ?>
                <li class="nav-item">
                    <a class="nav-link <?= uri_string() == 'produksi' ? 'active' : '' ?>" href="<?= base_url('produksi'); ?>">
                        <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                            <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                ...
                <li class="nav-item">
                    <a class="nav-link <?= uri_string() == 'etalase' ? 'active' : '' ?>" href="<?= base_url('etalase'); ?>">
                        <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                ...
                <li class="nav-item">
                    <a class="nav-link <?= uri_string() == 'opname' ? 'active' : '' ?>" href="<?= base_url('opname'); ?>">
                        <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                            <svg class="text-dark" width="16px" height="16px" viewBox="0 0 40 44" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                                <title>document</title>
                                <g id="Basic-Elements" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
    ...
    <div class="sidenav-footer mx-3 ">
        <a role="button" class="btn bg-gradient-danger w-100" href="<?= base_url('logout'); ?>"><i class="fa fa-sign-out"></i> Sign Out</a>
    </div>
</aside>